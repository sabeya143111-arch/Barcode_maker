...
# ===== PATH / LOGO SETTINGS =====
# ✅ FIX: Sirf ek level upar jaao, phir assets
BASE_DIR = Path(__file__).resolve().parent  # ek parent hi kaafi hai
